...
export default function WhatWeDo() {
  const rows = [
    ...
    },
    {
      ...
      text: "fiesta Hospitality's Asset Management team delivers tailored solutions throughout the hospitality life-cycle, aligning stakeholders with the owner's goals to drive successful partnerships, optimize asset value, and maximize returns through strategic initiatives.",
      list: [
        "Asset Optimization",
    ...
    },
    {
      ...
      text: "At fiesta Hospitality, we prioritize the owner’s interests, ensuring optimal results through constant communication and complete transparency. By tailoring our services to meet specific goals, we create strong partnerships and unlock the full potential of every asset.",
      list: [
    ...
    },
{
  number: 7,
  title: "Restaurants",
  text: "fiesta Hospitality ranks among Beirut’s, Abuja’s, Obudu’s and Riyadh’s fastest-growing F&B operators, with a portfolio of unique, award-winning restaurants that are renowned for providing guests with highly memorable dining experiences.",
  list: [
    "All day dining",
    "Restaurant",
    "Restaurant & Lounge",
